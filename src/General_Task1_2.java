...
public class General_Task1_2 {
    ...
    public static void main(String[] args) throws IOException {
        Buyer b1 = new Buyer("Ivan", 26, Discount.VIP);
        Buyer b2 = new Buyer("Nastya", 60, Discount.STANDARD);
        Buyer b3 = new Buyer("Kirill", 22, Discount.VIP);
        Buyer b4 = new Buyer("Kate", 60, Discount.MEDIUM);
        Buyer b5 = new Buyer("Alex", 35, Discount.STANDARD);
        Buyer b6 = new Buyer("Misha", 3, Discount.MEDIUM);
        Buyer b7 = new Buyer("Tolya", 11, Discount.VIP);
        Buyer b8 = new Buyer("Petya", 65, Discount.STANDARD);
        Buyer b9 = new Buyer("Igor", 15, Discount.MEDIUM);
        Buyer b10 = new Buyer("Volodya", 100, Discount.MEDIUM);
        Buyer b11 = new Buyer("Vasya", 1, Discount.STANDARD);
        Buyer b12 = new Buyer("Igor", 27, Discount.VIP);
